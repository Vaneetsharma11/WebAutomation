    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.chrome.driver", "/Users/vaneetsharma/Downloads/Web_automation/Generic/src/test/resources/chromedriver");
            ...
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.gecko.driver", "D:\\FrameworkSetup\\group6WebAutomation-master\\Homedepot\\Generic\\src\\main\\resources\\chromedriver.exe");
            }else if(OS.equalsIgnoreCase("Windows")) {
